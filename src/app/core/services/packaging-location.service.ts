...
export class PackagingLocationService {
   ...
   */
  getById(id: number) {
    return this.http.get<any>(`${environment.apiUrl}packagingLocation/${id}`);
  }
  ...
  create(packagingLocation: any, packagingLocationId: string) {
    ...
    return this.http.post<any>(`${environment.apiUrl}packagingLocation?columnId=${packagingLocationId}`, packagingLocation);
  }
  ...
  createMultiplePackagingLocations(packagingLocations: any[]) {
    return this.http.post<any>(`${environment.apiUrl}packagingLocation/create-multiple`, packagingLocations);
  }
  ...
  update(packagingLocation: any) {
    return this.http.put<any>(`${environment.apiUrl}packagingLocation/${packagingLocation._id}`, packagingLocation);
  }
   ...
   */
  delete(id: number) {
    return this.http.delete<any>(`${environment.apiUrl}packagingLocation/${id}`);
  }
