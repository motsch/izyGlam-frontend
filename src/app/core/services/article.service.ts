...
export class ArticleService {
    ...
    createMultipleArticles(articles: any[]) {
        return this.http.post<any>(
            `${environment.apiUrl}articles/create-multiple`,
            articles
        );
    }
    ...
    update(article: any) {
        return this.http.put<any>(
            `${environment.apiUrl}articles/${article._id}`,
            article
        );
    }
    ...
    checkQuantity(productID: string, quantity: string) {
        return this.http.get<any>(
            `${environment.apiUrl}articles/check-quantity/${productID}/${quantity}`
        );
    }
    ...
    getByName(productID: any) {
        return this.http.get<any>(
            `${environment.apiUrl}allee/nom/${productID.name}/productID/${productID.productID}/client/${productID.client}`
        );
    }
    ...
    manuallyDeleteArticleInAllee(alleeName: string, articleName: string) {
        return this.http.delete<any>(
            `${environment.apiUrl}allee/${alleeName}/article/${articleName}`
        );
    }
    ...
    robotDeleteArticleInAllee(alleeName: string) {
        return this.http.get<any>(
            `${environment.apiUrl}allee/robotDeleteArticleInAllee/${alleeName}`
        );
    }
    ...
    inventaireAllee(allee: any) {
        return this.http.post<any>(
            `${environment.apiUrl}allee/inventaireAllee/${allee.name}/${allee.dollyCount}`,
            allee
        );
    }
    ...
    getNumberOfArticlesByAllee(alleeName: string) {
        return this.http.get<any>(
            `${environment.apiUrl}allee/getNumberOfArticlesByAllee/${alleeName}`
        );
    }
    ...
    createBoschMission(requestObject: any) {
        return this.http.post<any>(
            `${environment.apiUrl}missions/create-new-bosch`,
            requestObject
        );
    }
