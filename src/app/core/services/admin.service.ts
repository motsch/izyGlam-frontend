...
export class AdminService {
   ...
   */
  update(admin: any) {
    return this.http.put<any>(`${environment.apiUrl}admin/${admin._id}`, admin);
  }
  ...
  createBoschConfig(boschConfig: any) {
    return this.http.post<any>(`${environment.apiUrl}boschConfig`, boschConfig);
  }
  ...
  updateBoschConfig(boschConfig: any) {
    return this.http.put<any>(`${environment.apiUrl}boschConfig/${boschConfig._id}`, boschConfig);
  }
}
