...
@Component({
  selector: 'app-admin-izyshop-orders',
  templateUrl: './admin-izyshop-orders.component.html',
  styleUrls: ['./admin-izyshop-orders.component.scss']
})
export class AdminIzyshopOrdersComponent implements OnInit {
  leads: any[] = [];
  filteredLeads: any[] = [];
